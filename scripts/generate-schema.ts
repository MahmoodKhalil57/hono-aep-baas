...
import { kindCms } from "../src/cms/kind.cms";
...
const kind = defineResource({ ...composable(kindCms), parent: project });
...
const schema = generateSqliteSchema({ resources: [project, form, submission, collection, domain, kind, theme, page, block] });
